// Welcome to quick-mail.js 3.2.8a
...
jQuery(document).ready(function() {
	...
	console.log("534 qmjs. saving? " + save_addresses);
	update_saved_cc_addresses();
	// clear_qm_addresses
	if (got_saved_qm_addresses()) {
		console.log("549 qmjs. got addresses"); 
	} else {
		console.log("551 qmjs. **NO addresses **");
	}
	if (save_addresses == 'N' && got_saved_qm_addresses()) {
		clear_qm_addresses();
		console.log("555 qmjs. CLEARED addresses"); 
